...
class Eventos(ctk.CTkFrame):
    ...
    def widgets(self):
        ...
        """Botones del frame"""
        self.btn = ctk.CTkButton(self,text=None,image=self.imagen_boton_retroceder,fg_color="black",hover_color="black",bg_color="black",cursor="hand2",command=lambda:[self.volver()])
